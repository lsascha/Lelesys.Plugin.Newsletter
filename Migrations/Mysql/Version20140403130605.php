 ...
 */
class Version20140403130605 extends AbstractMigration {
	...
	public function up(Schema $schema) {
		...
		$this->addSql("CREATE TABLE lelesys_plugin_newsletter_domain_model_category (persistence_object_identifier VARCHAR(40) NOT NULL, title VARCHAR(255) NOT NULL, PRIMARY KEY(persistence_object_identifier)) ENGINE = InnoDB");
		$this->addSql("CREATE TABLE lelesys_plugin_newsletter_domain_model_recipient_abstractgroup (persistence_object_identifier VARCHAR(40) NOT NULL, title VARCHAR(255) NOT NULL, dtype VARCHAR(255) NOT NULL, PRIMARY KEY(persistence_object_identifier)) ENGINE = InnoDB");
		$this->addSql("CREATE TABLE lelesys_plugin_newsletter_domain_model_recipient_group_party (persistence_object_identifier VARCHAR(40) NOT NULL, PRIMARY KEY(persistence_object_identifier)) ENGINE = InnoDB");
		$this->addSql("CREATE TABLE lelesys_plugin_newsletter_domain_model_recipient_group_st_59daa (persistence_object_identifier VARCHAR(40) NOT NULL, recipientlist TEXT, PRIMARY KEY(persistence_object_identifier)) ENGINE = InnoDB");
		$this->addSql("CREATE TABLE lelesys_plugin_newsletter_domain_model_recipient_person (persistence_object_identifier VARCHAR(40) NOT NULL, gender TINYINT(1) NOT NULL, acceptshtml TINYINT(1) DEFAULT NULL, PRIMARY KEY(persistence_object_identifier)) ENGINE = InnoDB");
		$this->addSql("CREATE TABLE lelesys_plugin_newsletter_domain_model_recipi_70879_groups_join (newsletter_recipient_person VARCHAR(40) NOT NULL, plugin_group_party VARCHAR(40) NOT NULL, INDEX IDX_C39CD389BA709A88 (newsletter_recipient_person), INDEX IDX_C39CD3891EC1F73D (plugin_group_party), PRIMARY KEY(newsletter_recipient_person, plugin_group_party)) ENGINE = InnoDB");
		...
		$this->addSql("CREATE TABLE lelesys_plugin_newsletter_domain_model_ne_11124_categories_join (newsletter_newsletter VARCHAR(40) NOT NULL, newsletter_category VARCHAR(40) NOT NULL, INDEX IDX_B49207ED9390BC62 (newsletter_newsletter), INDEX IDX_B49207EDDB4EDFAB (newsletter_category), PRIMARY KEY(newsletter_newsletter, newsletter_category)) ENGINE = InnoDB");
		$this->addSql("CREATE TABLE lelesys_plugin_newsletter_domain_mod_11124_recipientgroups_join (newsletter_newsletter VARCHAR(40) NOT NULL, newsletter_recipient_abstractgroup VARCHAR(40) NOT NULL, INDEX IDX_28D983869390BC62 (newsletter_newsletter), INDEX IDX_28D983862A8E4F6B (newsletter_recipient_abstractgroup), PRIMARY KEY(newsletter_newsletter, newsletter_recipient_abstractgroup)) ENGINE = InnoDB");
		$this->addSql("CREATE TABLE lelesys_plugin_newsletter_domain_model_ne_11124_recipients_join (newsletter_newsletter VARCHAR(40) NOT NULL, newsletter_recipient_person VARCHAR(40) NOT NULL, INDEX IDX_15C731869390BC62 (newsletter_newsletter), INDEX IDX_15C73186BA709A88 (newsletter_recipient_person), PRIMARY KEY(newsletter_newsletter, newsletter_recipient_person)) ENGINE = InnoDB");
	...
	public function down(Schema $schema) {
		...
		$this->addSql("ALTER TABLE lelesys_plugin_newsletter_domain_model_n_11124_attachments_join DROP FOREIGN KEY FK_8631FD5F9390BC62");
